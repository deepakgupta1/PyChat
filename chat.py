...
def app_version():
    msg_box("Application Version", "PyChat v1.0")
...
def update_list(self, data):
	print ('\a')
	#os.system('play --no-show-progress --null --channels 1 synth %s sine %f' % (2,5000))
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QApplication.translate("MainWindow", 
        	"PyChat", None, QApplication.UnicodeUTF8))
    ...
    def start_server(self):
        try:
            thread.start_new_thread(server_socket, (self,))
            msg_box("Success", "Server Started Sucessfully")
        except:
            msg_box("Server Error!!","Server cannot be Started")
